...
De exakta organisatoriska kraven finns definierade i [Bilaga B, avsnitt B.1.01–B.1.07](../bilagor/bilaga-b-krav-infrastrukturtjanster). I korthet innebär det att er organisation måste:
...
### 2. Tekniska krav
De detaljerade tekniska kraven finns definierade i [Bilaga B, avsnitt B.1.10–B.1.14](../bilagor/bilaga-b-krav-infrastrukturtjanster). I korthet måste ni:
* Driva en anslutningstjänst som publicerar och hanterar metadata strikt enligt [Bilaga D — Tekniska specifikationer](../bilagor/bilaga-d-tekniska-specifikationer).
...
* Ni verifierar att de uppfyller tillämpliga delar av [Bilaga C — Krav på medlemskomponenter](../bilagor/bilaga-c-krav-medlemskomponenter).
